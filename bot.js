    ...
    setInterval(async () => { 
        if (config.AUTOBIO == 'true') {
            if (conn.user.jid.startsWith('90')) { 
                ...
                const biography = '📅 ' + utch + '\n⌚ ' + ov_time + '\n\n⏱ Auto Bio By... 🎆powered By PODDA -Z'
...
// ════════════════════AUTO BIO◽◽◽◽◽    
    setInterval(async () => { 
        ...
        while (getGMTh == 19 && getGMTm == 1) {
            var announce = ''
            if (config.LANG == 'EN') announce = '📢◉◉😌PODDA -Z◉◉ \n🪔Announcement SYSTEM 💠'
            if (config.LANG == 'SI') announce = '📢◉◉😌PODDA -Z◉◉ \n🪔නිවේදන පද්ධතිය 💠'
            if (config.LANG == 'ID') announce = '📢◉◉😌PODDA -Z◉◉ \n🪔Announcement System 💠'
